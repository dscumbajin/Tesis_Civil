    ...
    ================================================== -->
		...
		<div class="container marketing">
				...
				<c:forEach items="${estaciones}" var="estacion">
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						...
						<h4>
							 ...
							 <span
								class="label label-default">${estacion.ubicacion}</span>

						</h4>
						<p>
							<a class="btn btn-sm btn-primary"
								href="detail?idEstacion=${estacion.id}"
								role="button">Consulta Detalle &raquo;</a>
						</p>
					</div>
				</c:forEach>
			</div>
			...
			<div class="page-header">
				<h2 class="text text-center"><span class="label label-success">Notificaciones</span></h2>
			</div>
